...
if ($ok) {
    ...
    if ($id) {
        ...
        list($endpoint, $params) = urait_get_launch_data($urait, $nonce, $messagetype, $foruserid);
    } else {
        ...
        $request = urait_build_content_item_selection_request($typeid, $course, $returnurl, $title, $text,
