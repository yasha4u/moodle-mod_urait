...
namespace uraitservice_toolsettings\local\resources;

use uraitservice_toolsettings\local\service\toolsettings;
...
/**
 * Class linksettings
 * @package uraitservice_toolsettings\local\resources
 */
class linksettings extends resource_base {
    ...
    public function execute($response) {
        ...
        if ($ok) {
            $ok = !empty($linkid);
            if ($ok) {
                $lti = $DB->get_record('urait', array('id' => $linkid), 'course,typeid', MUST_EXIST);
