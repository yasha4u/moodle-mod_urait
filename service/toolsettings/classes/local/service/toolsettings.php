 ...
 *
 * @package uraitservice_toolsettings
 * @copyright 2024 LMS-Service {@link https://lms-service.ru/}
 * @author Daniil Romanov
 * @license http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */

namespace uraitservice_toolsettings\local\service;

use mod_urait\local\uraitservice\service_base;
use mod_urait\local\uraitservice\resource_base;
use uraitservice_toolsettings\local\resources\systemsettings;
use uraitservice_toolsettings\local\resources\contextsettings;
use uraitservice_toolsettings\local\resources\linksettings;

defined('MOODLE_INTERNAL') || die();

/**
 * Class toolsettings
 * @package uraitservice_toolsettings\local\service
 */
class toolsettings extends service_base {
    ...
    public function get_launch_parameters($messagetype, $courseid, $user, $typeid, $modlti = null) {
        ...
        if (isset($tool->{$this->get_component_id()})) {
            ...
            if ($tool->{$this->get_component_id()} == self::SERVICE_ENABLED && $ok) {
