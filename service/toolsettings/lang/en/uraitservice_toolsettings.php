...
/**
 * Strings for component 'uraitservice_toolsettings', language 'en'
 *
...
$string['uraitservice_toolsettings'] = 'Tool Settings';
$string['uraitservice_toolsettings_help'] = 'Allow the tool to save and retrieve setting values.';
