...
/**
 * Strings for component 'uraitservice_basicoutcomes', language 'en'
 */

$string['allow'] = 'Use this service to accept grades from the tool';
$string['uraitservice_basicoutcomes'] = 'Basic Outcomes';
$string['uraitservice_basicoutcomes_help'] = 'Allow the tool to save and retrieve its grades to a gradebook column associated with each link.';
