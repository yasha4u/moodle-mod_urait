...
namespace uraitservice_memberships\local\resources;

use mod_urait\local\uraitservice\resource_base;
use uraitservice_memberships\local\service\memberships;
 ...
 * Class linkmemberships
 * @package uraitservice_memberships\local\resources
 */
class linkmemberships extends resource_base {
     ...
     * Class constructor.
     *
     * @param \uraitservice_memberships\local\service\memberships $service Service instance
     */
    ...
    public function execute($response) {
        ...
        if (!($lti = $DB->get_record('urait', array('id' => $linkid), 'id,course,typeid,servicesalt', IGNORE_MISSING))) {
            $response->set_code(404);
            return;
        }
