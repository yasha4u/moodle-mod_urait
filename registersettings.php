...
require_once($CFG->dirroot.'/mod/uraitlocallib.php');
...
$isupdate = !empty($id);
$pageurl = new moodle_url('/mod/urait/registersettings.php');
if ($isupdate) {
    $pageurl->param('id', $id);
}
if (!empty($returnto)) {
...
$redirect = new moodle_url('/mod/urait/toolproxies.php', array('tab' => $tab));
